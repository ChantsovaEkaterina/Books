...
mongodb.MongoClient.connect('mongodb://Ketrin:K060596@ds115625.mlab.com:17965/books', function (err, database) {
  if (err) {
    console.log(err);
    process.exit(1);
  }
...
app.post("/books", function(req, res) {
  ...
  if (!(req.body.bookTitle || req.body.authorsName)) {
    handleError(res, "Invalid input", "You must specify at least Book Title and Authors Name.", 400);
  }
